  ...
  return (
    <section id="contato">
      <div className="relative bg-accent overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-12 py-16 md:py-20 text-center reveal">
          ...
          <a
            ...
            className="mt-7 inline-flex items-center gap-2 rounded-lg bg-white text-accent font-semibold px-8 py-4 hover:scale-105 hover:shadow-lg active:scale-95 transition-transform w-full sm:w-auto justify-center"
          >
