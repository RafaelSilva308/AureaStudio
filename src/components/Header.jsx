    ...
    >
      <div className="max-w-6xl mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden md:inline-flex items-center rounded-lg bg-accent text-white text-sm font-semibold px-5 py-2.5 hover:scale-105 hover:shadow-lg active:scale-95 transition-transform"
        >
          Falar no WhatsApp
        </a>
      ...
      <div className={`md:hidden mobile-nav ${open ? "is-open" : ""}`}>
        <div>
          <div className="bg-bg border-t border-neutral/10 px-6 py-4 flex flex-col gap-4">
            {NAV_LINKS.map((link) => (
              <a
                key={link.href}
                href={link.href}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex justify-center items-center rounded-lg bg-accent text-white text-sm font-semibold px-5 py-3 active:scale-95 transition-transform"
            >
              Falar no WhatsApp
            </a>
          </div>
